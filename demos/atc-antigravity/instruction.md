...
Click on the aircraft 'dot' so select the aircraft. It will highlight.

![Aircraft selected](plane2.png)
...
![Aircraft destination](plane3.png)

The destination will appear as an 'x'. The aircraft pilot will steer 
as needed to reach the destination.

![Aircraft turning](plane4.png)
